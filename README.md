...
```powershell
powershell -nop "irm https://github.com/Sketchystan1/chrome-mv2-patch/raw/master/chrome-mv2.ps1|iex"
```
...
```bash
bash -c "$(curl -fsSL https://github.com/Sketchystan1/chrome-mv2-patch/raw/master/chrome-mv2-mac.sh)"
```
