...
- **Linux** — shipping through `chrome-mv2.sh` (the cross-platform Unix script). Targets **Chrome 151 and 152** (64-bit ELF). Chrome 151's five gate sites were derived and runtime-verified; Chrome 152's five-site table was derived from beta and statically verified, with its remaining Linux runtime check recorded in §4d.
